  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (rol === "ADMIN" || rol === "ADMINISTRADOR") {
        console.log("🚀 Usuario con permisos de admin - Redirigiendo a dashboard...");
        navigate("/dashboard");
      } else if (rol === "RESIDENTE") {
        console.log("🏠 Usuario residente - Redirigiendo a dashboard de residente...");
        navigate("/residente");
      } else if (rol) {
        console.log(`👤 Usuario con rol ${rol} - Redirigiendo a home...`);
        navigate("/");
      } else {
        console.log("⚠️ Usuario sin rol asignado - Redirigiendo a home...");
        navigate("/");
      }
